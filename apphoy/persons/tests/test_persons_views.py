...
class TestPersonsViews(TestCase):
    ...
    def test_person_add_view_unauthorised(self):
        ...
        self.assertRedirects(
            response=response,
            expected_url=reverse("person_list") + "person-no-permission/",
    ...
    def test_person_add_view_invalid_data(self):
        request = self.factory.post(
            path=reverse("person_list"),
            data={
                "action": "Add",
    ...
    def test_person_edit_view_unauthorised(self):
        ...
        response = self.client.post(
            path=reverse("person_edit", kwargs={"pk": person.id}), 
            data=data, 
            follow=True,
        )
        self.assertRedirects(
